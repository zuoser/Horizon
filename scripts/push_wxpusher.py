...
if not files:
    print('no zh digest, skip'); raise SystemExit(0)
...
[VIEW FULL](https://zuoser.github.io/Horizon/)'
payload = {'appToken': os.environ['WXPUSHER_APP_TOKEN'], 'content': content,
           'contentType': 3, 'uids': [os.environ['WXPUSHER_UID']]}
